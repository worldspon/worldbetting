        ...
        return (
            <div className={styles.bettingWrap}>
                <div className={styles.bettingTitleBox}>
                    <h1 className={styles.bettingTitle}>WorldLotto Game</h1>
                ...
                <div className={styles.bettingBoard}>
                    <div className={styles.bettingChoiceBox}>
                        <div className={styles.bettingGameTitleBox}>
                            ...
                            <h2 className={styles.currentGameTitle}>월드로또 {this.state.year}-{this.state.month < 10 ? '0' + this.state.month : this.state.month}-{this.state.day < 10 ? '0' + this.state.day : this.state.day} [140] {this.state.gameCount} 회차</h2>
                        </div>
                        <div className={styles.bettingButtonBoard}>
                            ...
                            <div className={styles.bettingCategoryBox + ' ' + styles.bettingPowerSingle}>
                                ...
                                <div className={styles.bettingTypeButtonBox}>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="파워" data-game="홀">
                                        <span className={styles.bettingType}>파워볼 홀</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="파워" data-game="짝">
                                        <span className={styles.bettingType}>파워볼 짝</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="파워" data-game="언더">
                                        <span className={styles.bettingType}>파워볼 언더</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="파워" data-game="오버">
                                        <span className={styles.bettingType}>파워볼 오버</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                </div>
                            </div>
                            <div className={styles.bettingCategoryBox + ' ' + styles.bettingPowerMix}>
                                ...
                                <div className={styles.bettingTypeButtonBox}>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="파워" data-game="홀  + 언더">
                                        <span className={styles.bettingType}>홀 + 언더</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="파워" data-game="짝 + 언더">
                                        <span className={styles.bettingType}>짝 + 언더</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="파워" data-game="홀 + 오버">
                                        <span className={styles.bettingType}>홀 + 오버</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                    <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="파워" data-game="짝 + 오버">
                                        <span className={styles.bettingType}>짝 + 오버</span>
                                        <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                    </button>
                                </div>
                    ...
                    <table className={styles.bettingListTable}>
                        ...
                        <tbody>
                            ...
                            {/* <tr className={styles.bettingListRow}>
                                <td>2019.12.04</td>
                                <td>{this.state.gameCount}</td>
                                <td>(일반)<span className={styles.noBreakWords}>홀</span></td>
                                <td>2,000,000</td>
                                <td>1,200,000,000</td>
                                <td>
                                    <button className={styles.bettingCancelButton}>취소</button>
                                </td>
                            </tr> */}
                        </tbody>
                    </table>
