...
import styles from './dropgame.css';
// 로그인 검증
...
class ZombieDrop extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            // 게임 결과테이블 결과부분 텍스트
            gameResultThText: [this.props.langPack.dropGame.tableTh[0], this.props.langPack.dropGame.tableTh[1]],
            bettingAllowStart: 0,
            bettingAllowEnd: 0,
            // 게임 세팅 정보
            minMaxBetting: [],
    ...
    setUserGameInfo(byteArray) {
        ...
        if(errorCode === 0) {
            ...
            this.setState({
                minMaxBetting: content.slice(60, 80),
                allocation: content.slice(150, 160),
                totalBettingLimit: content[183]
            });
