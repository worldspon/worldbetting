        ...
        return (
            <div className={styles.bettingWrap}>
                <div className={styles.bettingTitleBox}>
                    <h1 className={styles.bettingTitle}>Zombie Break</h1>
                ...
                <div className={styles.bettingBoard}>
                    <div className={styles.bettingChoiceBox}>
                        <div className={styles.bettingGameTitleBox}>
                            ...
                            <h2 className={styles.currentGameTitle}>좀비격파 {this.state.year}-{this.state.month < 10 ? '0' + this.state.month : this.state.month}-{this.state.day < 10 ? '0' + this.state.day : this.state.day} [140] {this.state.gameCount} 회차</h2>
                        </div>
                        <div className={styles.bettingButtonBoard}>
                            <div className={styles.bettingCategoryBox + ' ' + styles.bettingLeftRight}>
                                ...
                                <div className={styles.leftRightInnerWrap}>
                                    ...
                                    <div className={styles.bettingTypeButtonBox}>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="일반" data-game="짝">
                                            <span className={styles.bettingType}>짝</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="일반" data-game="짝">
                            ...
                            <div className={styles.bettingCategoryBox + ' ' + styles.bettingWinLose}>
                                ...
                                <div className={styles.winLoseInnerWrap}>
                                    <div className={styles.bettingTypeButtonBox}>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingGrayButton} data-ball="일반" data-game="왼쪽">
                                            <span className={styles.bettingType}>왼쪽</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="일반" data-game="언더 + 비김">
                                            <span className={styles.bettingType}>언더 + 비김</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="일반" data-game="오버 + 왼쪽">
                                            <span className={styles.bettingType}>오버 + 왼쪽</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                    </div>
                                    <div className={styles.bettingTypeButtonBox}>
                                        ...
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="일반" data-game="오버 + 비김">
                                            <span className={styles.bettingType}>오버 + 비김</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                    </div>
                                    <div className={styles.bettingTypeButtonBox}>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingGrayButton} data-ball="일반" data-game="오른쪽">
                                            <span className={styles.bettingType}>오른쪽</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingBlueButton} data-ball="일반" data-game="언더 + 오른쪽">
                                            <span className={styles.bettingType}>언더 + 오른쪽</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                        <button className={styles.bettingTypeButton + ' ' + styles.bettingRedButton} data-ball="일반" data-game="오버 + 오른쪽">
                                            <span className={styles.bettingType}>오버 + 오른쪽</span>
                                            <span className={styles.bettingAllocation}>(1.93 / 200)</span>
                                        </button>
                                    </div>
                                </div>
